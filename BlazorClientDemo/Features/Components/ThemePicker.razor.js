...
// Track which buttons we've already bound so onUpdate is idempotent.
...
// -----------------------------------------------------------------------------
// Lifecycle hooks invoked by the host (BlazorPageScript on Server/SSR, or the
// IJSObjectReference convention on WASM).
// -----------------------------------------------------------------------------
